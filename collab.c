...
void npate397_lsaad3() {
  printf("Neksha Patel and Layan Saad\n");
  printf("We learned that git/GitHub are amazing, powerful tools! However, I would like to
         " learn how to use config command in git. \n");
}
